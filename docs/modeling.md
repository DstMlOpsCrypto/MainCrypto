...
Results have beeen satisfactory using only past bitcoin prices on a short term approach. Model has been volontary keep simple due to the fact that it was not the main purpose of the projet.
